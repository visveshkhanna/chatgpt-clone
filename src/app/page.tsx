...
export default function Home() {
  return (
    <div className="flex flex-row bg-[#212121] h-screen w-full">
      <Sidebar />
      <div className="flex flex-col h-screen w-full">
        <NavBar />
        <MobileNavbar />
        <div className="flex-1 overflow-hidden">Logo and details</div>
        ...
        <div className="w-full px-4 lg:pl-0">
          ...
          <div className="flex flex-row pt-2">
            <Textarea
              ...
              className="resize-none border-[1px] hover:border-muted-foreground/40 focus:border-muted-foreground/40"
            />
